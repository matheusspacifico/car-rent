...
public class DeleteCustomerModal extends BasePage{
    ...
    private final By confirmButton = By.xpath("//mat-dialog-actions//button[.//span[contains(text(), 'Confirmar')]]");
    private final By cancelButton = By.xpath("//mat-dialog-actions//button[.//span[contains(text(), 'Cancelar')]]");
